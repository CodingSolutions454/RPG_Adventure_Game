...
// Sets default values
AAI_Bot_Character_RightUpBody::AAI_Bot_Character_RightUpBody()
{
...
void AAI_Bot_Character_RightUpBody::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AAI_Bot_Character_RightUpBody::Tick(float DeltaTime)
{
